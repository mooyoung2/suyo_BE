 ...
 * 경계값은 2,395개 조합 실측 분포의 P33/P67 (설계서 2-2 확정값, v3 2026-08-13: CUSTOMER 40점/총점 100점 기준으로 갱신).
 */
public final class RiskGrader {

    public static final double L1_LOW_CUT = 15.6;
    public static final double L1_HIGH_CUT = 21.6;
    public static final double L2_LOW_CUT = 18.9;
    public static final double L2_HIGH_CUT = 24.9;
    public static final double L3_LOW_CUT = 9.2;
    public static final double L3_HIGH_CUT = 14.5;
    public static final double TOTAL_LOW_CUT = 48.0;
    public static final double TOTAL_HIGH_CUT = 57.9;
